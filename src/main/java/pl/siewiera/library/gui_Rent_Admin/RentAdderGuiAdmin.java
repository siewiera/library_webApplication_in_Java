...
//system wypożyczeń
@Route("add_rent_Admin")
@StyleSheet("/css/style.css")
public class RentAdderGuiAdmin extends VerticalLayout {
    String tytul = "Wypożyczenie";//tytuł podstrony

    @Autowired
    public RentAdderGuiAdmin(ReaderRepo readerRepo, BookRepo bookRepo, RentRepo rentRepo) {
        ...
        Anchor odswiez = new Anchor("add_rent_Admin", refresh);
        ...
        readerSelect.setTextRenderer(Reader::getSurname);
