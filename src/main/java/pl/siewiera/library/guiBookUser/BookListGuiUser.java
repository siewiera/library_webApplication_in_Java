package pl.siewiera.library.guiBookUser;
...
@Route("list_book_User")
@StyleSheet("/css/style.css")
public class BookListGuiUser extends VerticalLayout {
    String tytul = "Lista książek";

    String książka="";
    @Autowired
    public BookListGuiUser(BookRepo bookRepo) {
